// Contrast — expands or compresses the input texture's RGB around a `pivot` by `amount` (alpha preserved).
...
final class Node: SZNode {
    ...
    func setup(_ ctx: SZSetupContext) {
        ...
        kernel void contrast(texture2d<float, access::read>  inTex  [[texture(0)]],
    ...
    func update(_ ctx: SZFrameContext) {
        ...
        var pivot = ctx.inputFloat("pivot") ?? 0.5

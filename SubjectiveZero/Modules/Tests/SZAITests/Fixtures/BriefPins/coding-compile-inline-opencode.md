...
deliberate rename is an explicit act — `subz_ui_update_node { "node": "22222222-2222-4222-8222-222222222222", "title": "...", "sfSymbol":
...
- **`sourceMismatch`** — the port audit found a fault: `Node.swift` reads or writes a port **name** the
  ...
  audit gates `subz_agent_compile_node`: while it errors nothing is promoted and the reply quotes the offending port
...
3. `subz_agent_report_status { "node": "22222222-2222-4222-8222-222222222222", "status": "ok" }`

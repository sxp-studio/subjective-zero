...
public struct SZAssignment: Codable, Sendable {
    /// The 1-based attempt this delivery is — the coding door's retry fork (bumped by the host for a node whose last attempt it failed and whose session survived).
